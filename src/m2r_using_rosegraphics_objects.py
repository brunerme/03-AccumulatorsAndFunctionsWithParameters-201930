...
#             you can construct OTHER than Circle and Point: Arc and ellipse
#
#
#          -- Write the names of three METHODs that Circle objects have:
#                clone(), attachto(), detachfrom()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have: center, default, fillcolor
#
...
#        necessary?  Why?
#        When you want to close the window to either end the program or open the next window. It stops the program from running.
#
